...
<body data-spy="scroll" data-target="nav">
        ...
        <section id="content-2-1" class="content-block content-2-1 bg-transparent bg-image-cover" style="background-image:url('<%=request.getContextPath()%>/resources/images/blur2.jpg');">
            <div class="row"> 
                <div class="col-md-12"> 
                    <form class="bookingFormContainer" action=""${pageContext.request.contextPath}/UpdateBookingsController" method="POST"> 
                        <div class="card"> 
                            <div class="card-header"> 
                               <h4 style="color: #F4E256;">Confirm Updated Booking</h4>
                            </div>                             
                            <div class="card-body"> 
                                <div class="form-group"> 
                                    <table>
                                        <tr>
                                            <td> <h5 style="color : white;">Total Charges = Rs.</td>
                                            <td> <h5 style="color : white;">${Totalcost} </h5> </td>
                                        </tr>
                                    </table>
                     			</div>
                            </div>                             
                            <div class="card-footer"> 
                                <table>
                                    <tr>
                                        <td><input style="margin-right: 10px;" type="submit" name="WantToConfirm" value="Confirm" class="btn btn-primary"> </td>
                                        <td><input type="submit" name="WantToCancel" value="Cancel" class="btn btn-primary"> </td>
                                    </tr>
                                </table>
