...
<body data-spy="scroll" data-target="nav">
        ...
        <section id="content-2-1" class="content-block content-2-1 bg-transparent bg-image-cover" style="background-image:url('<%=request.getContextPath()%>/resources/images/blur2.jpg');">
            <div class="row"> 
                <div class="col-md-12"> 
                    <form class="bookingFormContainer mb-3" action="${pageContext.request.contextPath}/AddBookingsController" method="POST"> 
                        <div class="card"> 
                            <div class="card-header"> 
                                <h4 style="color: #F4E256; text-align : center;">Add Booking</h4>
							</div>                             
                            <div class="card-body"> 
                                <div class="form-group"> 
                                    <input type="text" name="EventName" class="form-control" placeholder="Enter Event Name"  autocomplete="off" required/> 
                                </div>
                                <div class="form-group"> 
                                    <input type="text" name="EventType" class="form-control" placeholder="Enter Event Type" autocomplete="off" required/> 
                                </div>                                 
                                <div class="form-group"> 
                                	<label style="color : #F4E256">Enter Event Date:-</label>
                                    <input type="date" name="EventDate" class="form-control" placeholder="Enter Date" autocomplete="off" required/> 
                                </div>                                 
                                <div class="form-group">
                                	<label style="color : #F4E256">Enter Starting Time:-</label> 
                                    <input type="time" name="StartsAt" class="form-control" autocomplete="off" required/> 
                                </div>   
                                <div class="form-group">
                                	<label style="color : #F4E256">Enter Ending Time:-</label> 
                                    <input type="time" name="EndsAt" class="form-control" autocomplete="off" required/> 
                                </div>                                                            
                                <div class="form-group"> 
                                    <input type="text" name="NoOfParticipants" class="form-control" placeholder="NoOfParticipants" autocomplete="off" required/> 
                                </div>                                 
                            </div>                             
                            <div class="card-footer text-center"> 
                                <input type="submit" value="Check Available Venues" class="btn btn-primary"> 
                                <input type="hidden" name="checkActionVenue" value="checkAvailableVenues">
                            </div>                             
                        </div>                         
                    </form>                     
                </div>                 
