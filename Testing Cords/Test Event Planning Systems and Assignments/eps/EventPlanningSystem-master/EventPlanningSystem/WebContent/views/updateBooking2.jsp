                        ...
                        <div class="card"> 
                            ...
                            <div class="card-body"> 
                                <div class="form-group"> 
                                   	<label style="color : #F4E256">Venue :-</label> 
                                    <select name="venueSelection" class="form-control" required>
                                    	<option value="${BookingToUpdate.getVenueID()}" selected hidden>${BookingToUpdate.getVenueName()} </option>
                                    	<c:forEach items="${availableVenuesToDisplay}" var="venue">
                                 ...
                                 <div class="form-group"> 
                                 	<label style="color : #F4E256">Foods and Beverages Supplier :-</label> 
                                    <select name="MealSelection" class="form-control">
                                    	<option value="${BookingToUpdate.getMealID()}" selected hidden>${BookingToUpdate.getMeals()} </option>
                                ...
                                <div class="form-group"> 
                                	<label style="color : #F4E256">Sound & Lighting Supplier :-</label> 
                                    <select name="Sound&LightningSelection" class="form-control">
                                    	<option value="${BookingToUpdate.getSoundAndLightingID()}" selected hidden>${BookingToUpdate.getSoundLighting()}</option>
                                ...
                                <div class="form-group"> 
                                	<label style="color : #F4E256">Decoration Supplier :-</label> 
                                    <select name="Decorations" class="form-control">
                                    	<option value="${BookingToUpdate.getDecorationID()}" selected hidden>${BookingToUpdate.getDecoration()}</option>
                            ...
                            <div class="card-footer text-center"> 
                                ...
                                <input type= "hidden" value= "CalculateCostAction" name="CalculateCost">
                            </div>                             
                        </div>                         
                    </form>                     
                </div>                 
